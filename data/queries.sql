...
-- get most populated countries (from the cities we know about those countries)
...
-- get all cities that have different-looking name but that UTF8 considers equal (case and accent insensitie)
...
-- get countries from Oceania that have at least one city in region OTHER
...
-- get cities in different countries that are very close to each other
